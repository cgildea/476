...
\input cstuff
\headline{{\bf CECS 476\hfill Homework 5 \hfill Spring 2004}}
...
Note: the first smaller partition you create in this assignment
will be used in the next assigment.
\bye
